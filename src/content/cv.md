...
- Designed and built two globally distributed AWS services, including the customer-facing storefront and a file-upload and asynchronous-processing platform, using Route 53 latency-based routing and regional failover across ECS and EKS deployments, with infrastructure managed through AWS CDK
